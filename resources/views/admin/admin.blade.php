            ...
            <div class="table-responsive">
                <table class="table">
                   ...
                   <td>{{ implode(', ', $productIds) }}</td>
                                ...
                                <td class="{{ optional($order->orderproducts->first())->status === 'pending' ? 'text-yellow' : (optional($order->orderproducts->first())->status === 'cancelled' ? 'text-red' : (optional($order->orderproducts->first())->status === 'received' ? 'text-green' : '')) }}">
